  ...
  export const gameData: Scene[] = [
    {
      ...
      choices: [
        { text: "Order another drink and relax", nextScene: 2 },
        { text: "Gamble with some locals", nextScene: 3 },
    ...
    },
    {
      ...
      choices: [
        { text: "Stay calm and observe", nextScene: 5 },
        { text: "Order another drink", nextScene: 6 },
